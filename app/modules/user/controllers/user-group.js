...
define(function(){
    ...
    return ['$scope', '$routeParams', '$location', 'auth', 'action', 'group', function($scope, $routeParams, $location, auth, Action, Group){
        ...
        $scope.changeValidity = function(index, status){
            ...
            var promise = Group.changStatus({id: $scope.data[index].groupId, status: status}).$promise;
